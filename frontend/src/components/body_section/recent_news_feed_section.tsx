  ...
  return (
    <section className="flex flex-col relative justify-center items-center border border-green-600">
      ...
      <div className="w-full h-250 pt-8">
        ...
        {/** Image section **/}
        <div className="flex justify-center items-center gap-4 mx-85 pt-12 mt-10 mb-4">
          {/** Images 1 **/}
          <div className="relative w-[31%] h-125">
            ...
            <div className="group relative w-full h-[64%] overflow-hidden cursor-pointer">
              {/* Overlay fades in from top */}
              <div
                className="absolute inset-0 bg-[#2B2B5E] opacity-0 translate-y-[-100%] 
               transition-all duration-200 ease-in-out z-10
               group-hover:opacity-50 group-hover:translate-y-0"
              ></div>

              {/* Image layer that fades out to the left on hover */}
              <div
                className="absolute inset-0 bg-[url('/recent_news_feed/blog-1-1.jpg')] bg-cover bg-center 
               transition-all duration-700 ease-in-out z-0
               group-hover:opacity-0 group-hover:-translate-x-1/3"
              ></div>

              {/* Image layer that fades in from the right on hover */}
              <div
                className="absolute inset-0 bg-[url('/recent_news_feed/blog-1-1.jpg')] bg-cover bg-center 
              ...
              {/* Plus sign drops from top */}
              <span
                className="absolute text-white text-[48px] font-serif top-[30%] left-1/2 -translate-x-1/2 opacity-0
               transition-all duration-700 ease-in-out z-20
               group-hover:opacity-100 group-hover:top-[43%]"
              >
                +
              </span>
            </div>
          ...
          <div className="relative w-[31%] h-125">
            ...
            <div className="group relative w-full h-[64%] overflow-hidden cursor-pointer">
              ...
              {/* Image layer that fades out to the left on hover */}
              <div
                className="absolute inset-0 bg-[url('/recent_news_feed/blog-1-2.jpg')] bg-cover bg-center 
               transition-all duration-700 ease-in-out z-0
               group-hover:opacity-0 group-hover:-translate-x-1/3"
              ></div>
            ...
            <div className="flex flex-col z-15 gap-4 absolute bottom-[8] left-[20] bg-white w-83 h-55 shadow-sm">
              ...
              <span className="font-semibold text-[20px] pl-8 leading-[1.2em] tracking-[-0.04em] py-2 text-[#2B2B5E]">
                <a
                  ...
                  className="relative text-inherit transition-all duration-900 bg-no-repeat bg-[length:0_1px] bg-[0_calc(100%-1px)] bg-[linear-gradient(to_right,currentColor_0%,currentColor_100%)] hover:bg-[length:100%_1px]"
                >
                  In this space gain offline, <br /> but can we take this
                  <br /> online
                </a>
              </span>
          ...
          <div className="relative w-[31%] h-125">
            ...
            <div className="group relative w-full h-[64%] overflow-hidden cursor-pointer">
              ...
              {/* Image layer that fades out to the left on hover */}
              <div
                className="absolute inset-0 bg-[url('/recent_news_feed/blog-1-3.jpg')] bg-cover bg-center 
               transition-all duration-700 ease-in-out z-0
               group-hover:opacity-0 group-hover:-translate-x-1/3"
              ></div>
            ...
            <div className="flex flex-col z-15 gap-4 absolute bottom-[8] left-[20] bg-white w-83 h-55 shadow-sm">
              ...
              <span className="font-semibold text-[20px] pl-8 leading-[1.2em] tracking-[-0.04em] py-2 text-[#2B2B5E]">
                <a
                  ...
                  className="relative text-inherit transition-all duration-900 bg-no-repeat bg-[length:0_1px] bg-[0_calc(100%-1px)] bg-[linear-gradient(to_right,currentColor_0%,currentColor_100%)] hover:bg-[length:100%_1px]"
                >
                  Flesh that out locked and <br /> loaded, closing these
                  <br /> latest
                </a>
              </span>
